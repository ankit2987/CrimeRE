...
const CrimeAnalysis = () => {
  ...
  return (
    <>
      <style>{styles}</style>
      <div 
       style={{ backgroundImage: `url(${logo})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat',  backgroundPosition: 'left 10px top 0px', height:692 , width:1515 , overflow: 'hidden'}}>
